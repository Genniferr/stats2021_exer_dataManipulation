...
-   List each variable and the level of measurement. Note if there are
    ...
    -   research - nominal (no problem)
        -   height in cm - ratio (no problem)
            -   weight in kg - ratio (no problem)
        -   LVST1 - ordinal (not nominal)
        -   LVST2- ordinal (not nominal)
        -   LVST3- ordinal (not nominal)
    -   LVST4- ordinal (not nominal)
        -   FRST1- ordinal (not nominal)
